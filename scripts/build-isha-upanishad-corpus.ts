...
const rawVerses = [
  {
    ...
    commentary:
      "The opening verse establishes the omnipresence of the Divine and the principle of renunciation as the path to true enjoyment.",
    practicalNote:
      "Practice non-attachment and see the divine presence in all things.",
  ...
  },
  {
    ...
    translation:
      "If a man wishes to live a hundred years on this earth, he should live performing action. For you, who thus desire to live, there is no other way. By performing action thus, a man is not bound by it.",
    commentary:
      "Action performed without attachment to the results does not bind the soul.",
    practicalNote:
      "Perform your daily duties sincerely without obsessing over the results.",
  ...
  },
  {
    ...
    translation:
      "Sunless and covered with blind darkness are the worlds. To them go after death those who are slayers of the Self.",
    commentary:
      "Ignoring one's spiritual nature (slaying the Self) leads to ignorance and darkness.",
    practicalNote:
      "Do not neglect your inner spiritual life in the pursuit of purely material goals.",
  ...
  },
  {
    ...
    translation:
      "That One, though motionless, is swifter than the mind. The senses can never overtake It, for It ever goes before. Though stationary, It outstrips all runners. By It, the all-pervading air supports the activities of all beings.",
    commentary:
      "The Ultimate Reality transcends time, space, and sensory perception.",
    practicalNote:
      "Meditate on the stillness within that connects all movement.",
  ...
  },
  {
    ...
    commentary:
      "A paradoxical description of the Infinite, which is both immanent and transcendent.",
    practicalNote:
      "Recognize that the Divine is both far away in the cosmos and intimately close within your heart.",
  ...
  },
  {
    ...
    commentary:
      "Realizing the interconnectedness of all life eliminates hatred and delusion.",
    practicalNote:
      "Try to see your own struggles and joys reflected in the people you meet today.",
  ...
  },
  {
    ...
    commentary:
      "Grief and delusion arise from the illusion of separation. Unity consciousness brings perfect peace.",
    practicalNote:
      "When feeling isolated or grieving, remind yourself of the fundamental unity of all existence.",
  ...
  },
  {
    ...
    commentary:
      "Describes the attributes of the Supreme Being: pure, eternal, and the ultimate ordainer.",
    practicalNote:
      "Take refuge in the purity and eternal nature of your true self.",
  ...
  },
  {
    ...
    translation:
      "Into blind darkness enter they who worship ignorance; into greater darkness, as it were, enter they who are devoted to knowledge alone.",
    commentary:
      "Both absolute ignorance and mere intellectual knowledge without spiritual practice are pitfalls.",
    practicalNote:
      "Balance your intellectual pursuits with genuine spiritual practice and humility.",
  ...
  },
  {
    ...
    translation:
      "Distinct, indeed, they say, is the result of knowledge; distinct, they say, is the result of ignorance. Thus have we heard from the wise who have explained it to us.",
    commentary:
      "The paths of lower knowledge (material sciences) and higher knowledge (spiritual wisdom) yield different results.",
    practicalNote:
      "Recognize the value of both practical skills and inner wisdom.",
  ...
  },
  {
    ...
    translation:
      "He who knows both knowledge and ignorance, by ignorance overcomes death and by knowledge enjoys immortality.",
    commentary:
      "Integration of material duties (avidya) and spiritual knowledge (vidya) is essential for crossing the ocean of mortality and attaining immortality.",
    practicalNote:
      "Fulfill your worldly responsibilities while maintaining a focus on ultimate spiritual liberation.",
  ...
  },
  {
    ...
    translation:
      "Into blind darkness enter they who worship the unmanifest; into greater darkness, as it were, enter they who are devoted to the manifest.",
    commentary:
      "Exclusive attachment to either the unmanifested (formless) or the manifested (forms/rituals) is incomplete.",
    practicalNote:
      "Honor the formless Divine while also respecting its expression in the world of forms.",
  ...
  },
  {
    ...
    translation:
      "Distinct, indeed, they say, is what is produced by the manifest; distinct, they say, is what is produced by the unmanifest. Thus have we heard from the wise who have explained it to us.",
    commentary:
      "Each path has its specific cosmic result, as taught by the ancient seers.",
    practicalNote:
      "Learn from the ancient wisdom about the different fruits of various spiritual practices.",
  ...
  },
  {
    ...
    translation:
      "He who knows both the manifest and the unmanifest (destruction), by the unmanifest overcomes death and by the manifest enjoys immortality.",
    commentary:
      "A holistic understanding of creation and destruction leads to ultimate liberation.",
    practicalNote:
      "Accept the cycles of creation and destruction in life as necessary steps to spiritual freedom.",
  ...
  },
  {
    ...
    translation:
      "The face of Truth is hidden by a golden disk. O Pushan (Effulgent Being), uncover it so that I, who am devoted to Truth, may behold it.",
    commentary:
      "The dazzling allure of the material world hides the ultimate spiritual Truth. A prayer for divine revelation.",
    practicalNote:
      "Pray for clarity to see past the glittering distractions of the material world.",
  ...
  },
  {
    ...
    translation:
      "O Pushan, O Sun, sole traveler, controller, son of Prajapati, gather your rays, withdraw your light. I behold your most glorious form. The Purusha (Being) who dwells there, I am He.",
    commentary:
      "The realization of the ultimate identity between the individual soul and the Supreme Being.",
    practicalNote:
      "Affirm your inherent divinity and your connection to the supreme light.",
  ...
  },
  {
    ...
    translation:
      "Let my vital breath merge into the all-pervading, immortal Prana. Let this body be burnt to ashes. O mind, remember your deeds! Remember, O mind, remember your deeds!",
    commentary:
      "A final prayer at the time of death, recalling one's actions and focusing the mind on the eternal.",
    practicalNote:
      "Live your life in such a way that at the end, you can remember your deeds with peace.",
  ...
  },
  {
    ...
    translation:
      "O Agni, lead us by the good path to the enjoyment of the fruit of our good deeds. You know, O God, all our actions. Destroy our deceitful sins. We offer you our countless salutations.",
    commentary:
      "A concluding prayer for guidance, purification from sin, and grace on the spiritual journey.",
    practicalNote:
      "Seek divine guidance to stay on the righteous path and overcome your inner flaws.",

...
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Date checked                     | 2026-06-30                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Evidence source                  | Local repository state on branch `codex/p1-0b-truthful-release-baseline`; audited base commit `b904cdf9203274682f4188a3b3faa84b21dbc311`; P1.0B implementation commit `d0c6543`; P1.0B decision-log evidence commits `061adf1` and `7339602`; merge-time branch tip must be verified with `git rev-parse --short HEAD` because a committed file cannot name its own final hash without becoming stale; local Next docs under `node_modules/next/dist/docs`; required verification command output                                                                                                                                                                                                                                                                                                                                                                                                                                           |

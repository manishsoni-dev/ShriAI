...
Do not mark staging certification complete until a human operator attaches
actual evidence for every row. Evidence can be a timestamped screenshot, log
excerpt with secrets redacted, staging database query result with identifiers
masked, or linked test-run artifact. This repository does not claim these
manual checks have passed.

| Check                                           | Required evidence                                                                                                                                                                                               | Status                 |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| All rollout flags disabled by default           | Staging and production environment snapshots showing absent or `false` flags                                                                                                                                    | Pending human evidence |
| Separate Supabase staging project               | Supabase project reference/name proving it is not production                                                                                                                                                    | Pending human evidence |
| Exact callback URL allowlist                    | Supabase Auth URL configuration showing only exact staging callback URLs                                                                                                                                        | Pending human evidence |
| Email confirmation enabled                      | Supabase Auth setting showing confirm-email enabled                                                                                                                                                             | Pending human evidence |
| Resend SMTP only for Supabase Auth-owned emails | Supabase SMTP settings evidence; no Next.js `RESEND_API_KEY` activation                                                                                                                                         | Pending human evidence |
| Valid signup                                    | New staging-only email signup result before confirmation                                                                                                                                                        | Pending human evidence |
| Confirmation callback                           | Confirmed email callback provisions app user and workspace only after verified claims                                                                                                                           | Pending human evidence |
| Repeated callback                               | Reusing the same callback cannot create duplicate users/workspaces                                                                                                                                              | Pending human evidence |
| Malformed callback                              | Altered callback code redirects safely to sign-in                                                                                                                                                               | Pending human evidence |
| Expired callback                                | Expired or invalidated callback redirects safely to sign-in                                                                                                                                                     | Pending human evidence |
| Legacy-email collision                          | Existing Auth.js email cannot auto-link or create a parallel Supabase user                                                                                                                                      | Pending human evidence |
| Linked Supabase sign-in                         | Linked Supabase identity reaches protected routes                                                                                                                                                               | Pending human evidence |
| Unlinked Supabase sign-in denial                | Direct Supabase account without app link is signed out and denied                                                                                                                                               | Pending human evidence |
| Legacy Auth.js sign-in                          | Existing password-hash user still signs in through legacy credentials                                                                                                                                           | Pending human evidence |
| Conflicting sessions                            | Mismatched Supabase/Auth.js sessions deny access and clear both mechanisms                                                                                                                                      | Pending human evidence |
| Unified logout                                  | Logout clears Auth.js and Supabase sessions without exposing tokens or provider errors                                                                                                                          | Pending human evidence |
| Protected-route denial                          | `/dashboard`, `/chat`, `/knowledge`, `/knowledge/search`, `/api/chat/stream`, `/api/voice/transcribe`, `/api/events`, scripture review, onboarding, and admin routes deny unauthenticated access as appropriate | Pending human evidence |
| Rollback by disabling flags                     | Disabling server-side rollout flags restores legacy-only behavior                                                                                                                                               | Pending human evidence |

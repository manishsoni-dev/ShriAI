...
const faqs = [
  ...
  [
    "Are voice features generated by OpenAI?",
    "The first implementation uses browser speech APIs for mic input and voice output when the user browser supports them.",
  ],
  [
